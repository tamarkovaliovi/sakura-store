  ...
  <div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <main class="flex-grow py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
      ...
      >
        ...
        <RouterLink
          to="/products"
          class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-900 hover:bg-blue-800 transition"
        >
          Alışverişe Başla
        </RouterLink>
      </div>
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2 space-y-4">
          <div
            v-for="item in cart"
            :key="item.id"
            class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center transition hover:shadow-md"
          >
            <img
        ...
        <div class="lg:col-span-1">
          <div
            class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 sticky top-4"
          >
            ...
            <div class="space-y-4 text-sm text-gray-600">
              ...
              <div
                class="border-t border-gray-100 pt-4 flex justify-between items-center text-lg font-bold text-gray-900"
              >
                <span>Toplam</span>
                <span>${{ subtotal }}</span>
              </div>
