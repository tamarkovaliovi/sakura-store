  ...
  <div class="min-h-screen flex flex-col font-sans bg-background">
    ...
    <section class="relative h-[500px] flex items-center justify-center overflow-hidden">
      <div class="absolute inset-0 bg-gray-900">
        <img :src="homeImage" alt="Banner" class="w-full h-full object-cover opacity-60" />
      </div>
      
      <div class="relative z-10 text-center px-4 max-w-3xl">
        <h1 class="text-4xl md:text-6xl font-bold text-white mb-6">Tarzını Keşfet</h1>
        <p class="text-xl text-gray-200 mb-8">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Porro facere eos ad iure pariatur dolor inventore. Dicta provident aperiam, odit quibusdam amet, sit praesentium at voluptate unde animi voluptatibus id!.</p>
...
const fetchProducts = async () => {
  try {
    const response = await fetch('https://api.escuelajs.co/api/v1/products/?categoryId=1&offset=0&limit=12');
